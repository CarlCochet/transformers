# coding=utf-8
# Copyright 2022 Michael Janner and Qiyang Li and Sergey Levine and The HuggingFace Inc. team. All rights reserved.
#
...
class TrajectoryTransformerConfig(PretrainedConfig):
    ...
    Args:
        vocab_size (`int`, *optional*, defaults to 100):
            ...
            represented by the `trajectories` passed when calling [`TrajectoryTransformerModel`] or
            [`~TFTrajectoryTransformerModel`].
        ...
        type_vocab_size (`int`, *optional*, defaults to 2):
            The vocabulary size of the `token_type_ids` passed when calling [`TrajectoryTransformerModel`] or
            [`~TFTrajectoryTransformerModel`].
